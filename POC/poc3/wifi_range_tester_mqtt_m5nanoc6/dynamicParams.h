...
char AIO_SERVER     [AIO_SERVER_LEN + 1]        =  "192.168.0.101"; // "test.mosquitto.org";
char AIO_SERVERPORT [AIO_SERVERPORT_LEN + 1]    = "1883";     //1883, or 8883 for SSL
char AIO_USERNAME   [AIO_USERNAME_LEN + 1]      = "";
char AIO_KEY        [AIO_KEY_LEN + 1]           = "";

char AIO_PUB_TOPIC  [AIO_PUB_TOPIC_LEN + 1]     = "/iotj/rocketone/poc3";
char AIO_SUB_TOPIC  [AIO_SUB_TOPIC_LEN + 1]     = "/iotj/rocketone/poc3";
